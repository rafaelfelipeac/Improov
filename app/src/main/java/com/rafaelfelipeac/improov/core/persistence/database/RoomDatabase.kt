...
const val DATABASE_VERSION_50 = 50 // 1.9.0

@Database(
    entities = [GoalDataModel::class, ItemDataModel::class, HistoricDataModel::class, HabitDataModel::class],
    version = DATABASE_VERSION_50,
    exportSchema = false
)
